...
function showQuestions(index) {
    ...
    console.log("Options added to the question");
}
...
function disableOptions() {
    ...
    console.log("Options disabled after selection");
}
...
function showResult() {
    ...
    if (score > 15) {
        let scoreTag = '<span>and congrats! 🎉, You got <p>' + score + '</p> out of <p>' + questions.length + '</p
